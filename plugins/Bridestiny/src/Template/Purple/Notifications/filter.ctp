    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title uk-margin-remove-bottom"><?= ucwords($this->request->getParam('filter')) ?> Notifications</h4>
            </div>
            <div class="card-toolbar">
                ...
                <?php
                    if ($this->request->getParam('filter') == 'unread'):
                ?>
                ...
                <?php
                    elseif ($this->request->getParam('filter') == 'read'):
                ?>
            ...
            <div class="card-body <?php if ($notifications->count() == 0) echo 'uk-padding-remove' ?>">
                ...
                <div class="uk-alert-danger <?php if ($notifications->count() == 0) echo 'uk-margin-remove-bottom' ?>" uk-alert>
                    <p>Can't find <?= $this->request->getParam('filter') ?> notification.</p>
                </div>
                <?php
                    endif;
                ?>
